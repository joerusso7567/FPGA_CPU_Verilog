...
HD_PWD='C:/Users/isjoe/CPU_Project/CPU_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CPU_Project.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CPU_Project.tcl
